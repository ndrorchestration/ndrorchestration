...
| Account | URL | Role | Era |
|---|---|---|---|
| `Flickerflash` | https://github.com/Flickerflash | Origin / Legacy portfolio, Agent Lavender lineage | Dec 2025 – Jan 2026 |
| `ndrorchestration` | https://github.com/ndrorchestration | Operational present, active development | Jan 2026 – present |

> Both accounts are maintained. `Flickerflash` is the historical record. `ndrorchestration` is the live system.

---

## Repository Routing

### Flickerflash (Legacy — read-only unless explicitly noted)
...
| [AI-Prompt-Engineer](https://github.com/Flickerflash/AI-Prompt-Engineer) | PE | ARCHIVE | Public — Gold Star verified portfolio |
| [DGAF-Framework](https://github.com/Flickerflash/DGAF-Framework) | FG | PRIVATE | Private — CyberShield origin, IP protected |
| [Gold-star-standards](https://github.com/Flickerflash/Gold-star-standards) | PE | PRIVATE | Private — rubric standards |
| [chat-archives](https://github.com/Flickerflash/chat-archives) | OI | PRIVATE | Private — multi-platform conversation archive |

### ndrorchestration (Active — primary development)
...
## Duplicate / Overlap Risk Register

| Artifact Type | Risk | Resolution |
|---|---|---|
